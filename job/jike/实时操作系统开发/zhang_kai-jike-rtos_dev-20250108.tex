...
\normalsize
3年以上实时操作系统和\tech{AUTOSAR CP}基础软件栈开发经验，熟悉\tech{AUTOSAR OS}任务调度、中断管理和时序优化，熟悉\tech{Infineon Tricore}、\tech{Arm-M/R}等车规级\tech{MCU}芯片架构，具备高性能中央计算平台和车身域控制器的\tech{OS}模块开发与维测能力。
...
\begin{tabularx}{\textwidth}{@{}p{3.2cm}X@{}}
  ...
  \textbf{以太网通信} & \tech{SOME/IP}, \tech{SoAd, SD, PduR}, TCP/UDP配置 \\
...
\begin{itemize}
  ...
  \item[\ding{51}] \highlight{AUTOSAR CP基础软件配置}：负责\tech{BSW}模块配置和\tech{MCAL}配置，包括\tech{CanIf, LinIf, PduR, ComM, Dem, Dcm}等基础软件模块，完成\tech{ARXML}配置和代码生成，解决\tech{ECUExtract}合规检查错误和配置冲突问题}
