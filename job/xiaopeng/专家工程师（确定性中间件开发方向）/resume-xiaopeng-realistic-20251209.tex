...
\normalsize
5年汽车嵌入式软件开发经验，曾主导汽车嵌入式软件架构设计、确定性通信系统中间件配置、实时车载网络测试验证。

% ============ 关键能力 ============
\section*{关键能力}

\begin{itemize}
  \skillitem{AUTOSAR架构与系统集成}{精通\tech{Classic AUTOSAR}架构，熟悉\tech{Adaptive AUTOSAR}，具备高性能中央计算平台和车身域控制器集成经验，精通车载网络通信（\tech{CAN}/\tech{LIN}/以太网）}
