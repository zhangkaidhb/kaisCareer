...
\normalsize
5年汽车电子软件开发与集成经验，擅长基于\tech{Classic AUTOSAR}工具链开发、\tech{RTE}接口配置与代码生成、软件集成与发布流程管理，具备\tech{CI/CD}流水线设计和跨团队技术协调能力，熟悉发布计划对接、系统需求分派、软件版本与系统需求关系维护、市场质量问题对接分派及跟踪流程。
...
\begin{itemize}
  \item[\ding{51}] \highlight{AUTOSAR工具链开发与集成}：负责高性能计算平台的\tech{AUTOSAR CP}架构集成，主导基于\tech{Python}的\tech{yaml2arxml}转换工具和\tech{SWC}配置管理工具开发，实现从yaml脚本配置文件到ARXML和代码的全流程分布式管理自动化，替代\tech{Davinci Developer}核心功能，显著提升综合配置效率
  \item[\ding{51}] \highlight{RTE代码生成}：负责\tech{Contract Phase Generation}生成: \tech{SWC}的C语言头文件和\tech{implementation template}
