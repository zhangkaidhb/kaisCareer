...
\textbf{核心能力矩阵：}
\begin{itemize}
  \item \textbf{AUTOSAR架构}：精通AUTOSAR CP标准架构，熟悉Adaptive AUTOSAR架构和ARA服务，具备基于AUTOSAR CP的车身控制器架构经验
  \item \textbf{系统集成经验}：具备高性能计算平台集成经验，精通车身域控制器集成开发，精通车载网络通信架构（CAN/LIN/以太网）和系统级集成测试
  \item \textbf{确定性通信中间件}：主导SOME/IP服务配置测试，深入理解TSN协议族（IEEE802.1AS gPTP, 802.1Qbv, 802.1Qav）及QoS保障机制，了解DDS通信协议原理，具备车载以太网通信经验
  \item \textbf{软件开发能力}：精通Python面向对象编程及设计模式，具备多线程开发经验；精通MatLab Stateflow开发，具备丰富的汽车电子SWC开发经验；熟悉C编程，具备AUTOSAR架构代码调试经验；具备基于UML语言的架构设计能力
